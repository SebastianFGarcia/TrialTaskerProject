          ...
          <div class="py-12">
              <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                  <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                      <HeaderTable route_to="typeStage" :getData="getData" :create="openModal"/>
                      <Table :data="typeStage.data" :columns="columns" name="typeStage" :edit="openModal" :destroy="destroy" :getData="getData"/>
